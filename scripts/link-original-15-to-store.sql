...
-- ЗАМЕНИТЕ 'YOUR_STORE_ID_HERE' на реальный UUID!
...
SELECT
  gen_random_uuid(),
  'cebbe5fe-0512-4b24-96c9-3af7c948b3a4', -- Körset Store
  ean,
  id,
  CASE
  ...
  END,
  CASE
    WHEN ean IN ('4820000000001', '4820000000002', '4820000000009') THEN 'Молочные'

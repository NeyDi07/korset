...
(gen_random_uuid(), '4602545003018', 'Chicken Breast Fillet 1kg', 'Куриное филе грудки 1кг', 'Приосколье', 'Мясо', 'Птица', '1 кг', 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=400', 'Chicken breast meat, water, salt', 'Мясо куриной грудки, вода, соль', '[]', '["gluten-free","halal"]', 'yes', 'A', 95, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545004012', 'Beef Ground 400g', 'Фарш говяжий 400г', 'Мираторг', 'Мясо', 'Говядина', '400 г', 'https://images.unsplash.com/photo-1542276860-c1f5b29a9f84?w=400', 'Beef meat, 15% fat', 'Говяжье мясо, жирность 15%', '[]', '["gluten-free","halal"]', 'yes', 'B', 92, true, true, NOW(), NOW()),
...
(gen_random_uuid(), '4602545000013', 'Bonduelle Corn 340g', 'Bonduelle Кукуруза сладкая 340г', 'Bonduelle', 'Консервы', 'Овощные консервы', '340 г', 'https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=400', 'Sweet corn, water, sugar, salt', 'Сладкая кукуруза, вода, сахар, соль', '[]', '["vegan","gluten-free","halal"]', 'yes', 'A', 90, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545001019', 'Rio Mare Tuna 160g', 'Rio Mare Тунец в собственном соку 160г', 'Rio Mare', 'Консервы', 'Рыбные консервы', '160 г', 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400', 'Yellowfin tuna, water, salt', 'Тунец желтоперый, вода, соль', '[]', '["gluten-free","halal","pescatarian"]', 'yes', 'A', 95, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545002016', 'Sardo Sardines 125g', 'Sardo Сардины в масле 125г', 'Sardo', 'Консервы', 'Рыбные консервы', '125 г', 'https://images.unsplash.com/photo-1534939561126-855b8675edd7?w=400', 'Sardines, olive oil, salt', 'Сардины, оливковое масло, соль', '[]', '["gluten-free","halal","pescatarian"]', 'yes', 'B', 88, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545003012', 'Heinz Ketchup 570g', 'Heinz Кетчуп Томатный 570г', 'Heinz', 'Соусы', 'Кетчупы', '570 г', 'https://images.unsplash.com/photo-1596591606975-97ee5cef3a1e?w=400', 'Tomatoes, vinegar, sugar, salt, onion powder, spices', 'Томаты, уксус, сахар, соль, луковый порошок, специи', '["sugar"]', '["vegan","gluten-free"]', 'yes', 'C', 75, true, true, NOW(), NOW()),
...
(gen_random_uuid(), '4602545005013', 'Soy Sauce Kikkoman 150ml', 'Соевый соус Kikkoman 150мл', 'Kikkoman', 'Соусы', 'Соевые соусы', '150 мл', 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=400', 'Water, soybeans, wheat, salt', 'Вода, соевые бобы, пшеница, соль', '["gluten","soy"]', '["vegan"]', 'yes', 'C', 80, true, true, NOW(), NOW()),

-- === СНЕКИ И ЧИПСЫ (5 шт) ===
(gen_random_uuid(), '4602545000019', 'Lay''s Cheese 150g', 'Lay''s Сыр 150г', 'Lay''s', 'Снеки', 'Чипсы', '150 г', 'https://images.unsplash.com/photo-1566478989037-eec175784cd3?w=400', 'Potatoes, vegetable oil, cheese flavoring, salt, whey powder', 'Картофель, растительное масло, сырный ароматизатор, соль, сухая молочная сыворотка', '["milk","soy"]', '["vegetarian"]', 'unknown', 'D', 55, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545001016', 'Pringles Original 165g', 'Pringles Original 165г', 'Pringles', 'Снеки', 'Чипсы', '165 г', 'https://images.unsplash.com/photo-1566478989037-eec175784cd3?w=400', 'Dried potatoes, vegetable oil, rice flour, wheat starch, salt', 'Сушеный картофель, растительное масло, рисовая мука, пшеничный крахмал, соль', '["gluten","soy","milk"]', '["vegetarian"]', 'unknown', 'D', 58, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545002013', 'Cheetos Crunchy 85g', 'Cheetos Хрустящие сырные 85г', 'Cheetos', 'Снеки', 'Кукурузные палочки', '85 г', 'https://images.unsplash.com/photo-1621447504864-d8686e12698c?w=400', 'Corn meal, vegetable oil, cheese seasoning, salt, whey', 'Кукурузная мука, растительное масло, сырная приправа, соль, сыворотка', '["milk","soy"]', '["vegetarian"]', 'unknown', 'D', 52, true, true, NOW(), NOW()),
...
-- === ФРУКТЫ И ОВОЩИ (5 шт) ===
(gen_random_uuid(), '4602545000012', 'Golden Apples 1kg', 'Яблоки Голден 1кг', 'Сады Казахстана', 'Фрукты', 'Яблоки', '1 кг', 'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=400', 'Fresh Golden Delicious apples', 'Свежие яблоки сорта Голден', '[]', '["vegan","gluten-free","raw"]', 'yes', 'A', 100, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545001013', 'Bananas Ecuador 1kg', 'Бананы Эквадор 1кг', 'Frutas del Ecuador', 'Фрукты', 'Бананы', '1 кг', 'https://images.unsplash.com/photo-1571771894821-ce9b6c11b214?w=400', 'Fresh Cavendish bananas', 'Свежие бананы сорта Кавендиш', '[]', '["vegan","gluten-free","raw"]', 'yes', 'A', 100, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545002010', 'Cherry Tomatoes 500g', 'Помидоры черри 500г', 'Тепличный', 'Овощи', 'Томаты', '500 г', 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=400', 'Fresh cherry tomatoes', 'Свежие томаты черри', '[]', '["vegan","gluten-free","raw"]', 'yes', 'A', 100, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545003016', 'Cucumbers 1kg', 'Огурцы свежие 1кг', 'Тепличный', 'Овощи', 'Огурцы', '1 кг', 'https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=400', 'Fresh greenhouse cucumbers', 'Свежие тепличные огурцы', '[]', '["vegan","gluten-free","raw"]', 'yes', 'A', 100, true, true, NOW(), NOW()),

(gen_random_uuid(), '4602545004013', 'Avocado Hass 2pcs', 'Авокадо Хасс 2шт', 'MexFresh', 'Фрукты', 'Авокадо', '2 шт (~400г)', 'https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?w=400', 'Fresh Hass avocados, ripe', 'Свежие спелые авокадо сорта Хасс', '[]', '["vegan","gluten-free","raw","keto"]', 'yes', 'A', 95, true, true, NOW(), NOW()),

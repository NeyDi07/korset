-- ПОЛНАЯ ОЧИСТКА И ПЕРЕУСТАНОВКА 10 ПРОДУКТОВ
-- ⚠️ ВНИМАНИЕ: Удаляет ВСЕ товары из global_products и store_products!

-- 1. Удалить ВСЕ связи store_products (для вашего магазина или полностью)
-- Если хотите удалить только для одного магазина - добавьте: WHERE store_id = 'ваш-id'
DELETE FROM store_products;

-- 2. Удалить ВСЕ продукты из global_products

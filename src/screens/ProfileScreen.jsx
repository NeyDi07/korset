  ...
  const icons = {
    nosugar: (
      <svg width={w} height={h} viewBox="0 0 24 24" fill="none">
        <rect x="4" y="9" width="16" height="11" rx="2" fill="#A78BFA" opacity=".25" />
        <rect x="4" y="9" width="16" height="11" rx="2" stroke="#A78BFA" strokeWidth="1.8" />
        <path d="M8 9V7a4 4 0 018 0v2" stroke="#A78BFA" strokeWidth="1.8" strokeLinecap={lc} />
        <line x1="3" y1="3" x2="21" y2="21" stroke="#F87171" strokeWidth="2.2" strokeLinecap={lc} />
      </svg>
    ),
    nodairy: (
      <svg width={w} height={h} viewBox="0 0 24 24" fill="none">
        <path d="M9 3h6l2 5v12a1 1 0 01-1 1H8a1 1 0 01-1-1V8l2-5z" fill="#60A5FA" opacity=".2" />
        <path
          d="M9 3h6l2 5v12a1 1 0 01-1 1H8a1 1 0 01-1-1V8l2-5z"
          stroke="#60A5FA"
          strokeWidth="1.8"
        />
        <line x1="3" y1="3" x2="21" y2="21" stroke="#F87171" strokeWidth="2.2" strokeLinecap={lc} />
    ...
    nogluten: (
      <svg width={w} height={h} viewBox="0 0 24 24" fill="none">
        <path d="M12 2v20" stroke="#F59E0B" strokeWidth="1.8" strokeLinecap={lc} />
        <path
          d="M9 8c1 .7 2 1 3 .5M15 8c-1 .7-2 1-3 .5M9 12c1 .7 2 1 3 .5M15 12c-1 .7-2 1-3 .5"
          stroke="#F59E0B"
          strokeWidth="1.6"
          strokeLinecap={lc}
        />
    ...
    vegan: (
      <svg width={w} height={h} viewBox="0 0 24 24" fill="none">
        <path d="M21 4C10 4 5 12 5 20" stroke="#34D399" strokeWidth="1.8" strokeLinecap={lc} />
        <path
    ...
    egg: (
      <svg width={w} height={h} viewBox="0 0 24 24" fill="none">
        <path
          d="M12 3C8.8 3 6.5 8 6.5 12.3a5.5 5.5 0 1011 0C17.5 8 15.2 3 12 3Z"
          stroke="#FCD34D"
          strokeWidth="1.7"
          fill="rgba(252,211,77,.18)"
        />
      </svg>
    ),
    wheat: (
      <svg width={w} height={h} viewBox="0 0 24 24" fill="none">
        <path d="M12 3v18" stroke="#F59E0B" strokeWidth="1.7" strokeLinecap={lc} />
        <path
          d="M9 8c1 .7 2 1 3 .5M15 8c-1 .7-2 1-3 .5M9 12c1 .7 2 1 3 .5M15 12c-1 .7-2 1-3 .5"
          stroke="#F59E0B"
          strokeWidth="1.6"
    ...
    peanut: (
      <svg width={w} height={h} viewBox="0 0 24 24" fill="none">
        <path
          d="M10 4.5a3.5 3.5 0 100 7h4a3.5 3.5 0 100-7h-4ZM10 12.5a3.5 3.5 0 100 7h4a3.5 3.5 0 100-7h-4Z"
          stroke="#F59E0B"
          strokeWidth="1.7"
                    ...
                    >
                      ...
                      <span
                        style={{
                          ...
                          fontSize: 13,
                          fontWeight: 500,
                          color: profile.halal ? '#C4B5FD' : 'rgba(255,255,255,0.4)',
                        }}
                      >

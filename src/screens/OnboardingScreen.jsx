...
const ALLERGENS = [
  ...
  { id: 'tree_nuts', icon: 'nuts', ru: 'Орехи', kz: 'Жаңғақ' },
  { id: 'peanuts', icon: 'peanut', ru: 'Арахис', kz: 'Жержаңғақ' },
  { id: 'soy', icon: 'soy', ru: 'Соя', kz: 'Соя' },
  { id: 'fish', icon: 'fish', ru: 'Рыба', kz: 'Балық' },
  { id: 'crustaceans', icon: 'shell', ru: 'Морепродукты', kz: 'Теңіз өнімдері' },
  { id: 'sesame', icon: 'sesame', ru: 'Кунжут', kz: 'Күнжіт' },
]

// ID должны совпадать с src/constants/allergens.js (ТР ТС 022/2011 canonical IDs).
// Раньше были 'nuts'/'shellfish' → профиль сохранялся с legacy IDs и не матчился в fitCheck.
const ALLERGEN_ROWS = [
  ['milk', 'eggs', 'gluten'],
  ['tree_nuts', 'peanuts', 'soy'],
  ...
  return (
    ...
    >
      <rect
        ...
        height="12"
        rx="4"
        fill={active ? 'rgba(255,255,255,0.14)' : 'rgba(167,139,250,0.10)'}
      />
  ...
  switch (name) {
    ...
    case 'halal':
      return (
        <svg {...common}>
          <path
            d="M20 12.2A8.5 8.5 0 1 1 11.8 3a7 7 0 1 0 8.2 9.2Z"
            stroke="#A78BFA"
            strokeWidth="1.8"
            strokeLinecap="round"
          />
          <path
            d="M16.5 7.5l.6 1.6 1.7.1-1.3 1 .5 1.7-1.5-.9-1.5.9.5-1.7-1.3-1 1.7-.1.6-1.6Z"
            fill="#A78BFA"
          />
        </svg>
      )
    case 'allergens':
      return (
        <svg {...common}>
          ...
          />
          <path d="M12 9v4" stroke="#FCA5A5" strokeWidth="1.8" strokeLinecap="round" />
    ...
    case 'ai':
      return (
        <svg {...common}>
          ...
          />
          <path d="M9 11h6M9 14h4" stroke="#C4B5FD" strokeWidth="1.7" strokeLinecap="round" />
        </svg>
      )
    case 'alternatives':
      return (
...
function ChoiceIcon({ name, active = false, size = 18 }) {
  ...
  switch (name) {
    ...
    case 'nodairy':
      return (
        <svg {...common}>
          <path d="M9 3h6l2 5v12H7V8l2-5Z" stroke={color} strokeWidth="1.7" fill={fill} />
          <line
            x1="4"
            y1="4"
            x2="20"
    ...
    case 'nogluten':
      return (
        <svg {...common}>
          <path d="M12 2v20" stroke={color} strokeWidth="1.7" strokeLinecap="round" />
          <path
            d="M9 8c1 .7 1.8 1 3 .5M15 8c-1 .7-1.8 1-3 .5M9 12c1 .7 1.8 1 3 .5M15 12c-1 .7-1.8 1-3 .5"
            stroke={color}
            strokeWidth="1.6"
            strokeLinecap="round"
          />
    ...
    case 'vegan':
      return (
        <svg {...common}>
          <path d="M21 4C10 4 5 12 5 20" stroke="#34D399" strokeWidth="1.8" strokeLinecap="round" />
          <path
            d="M5 20c3-7 8-12 16-11-1 4-4 10-16 11Z"
            stroke="#34D399"
            strokeWidth="1.8"
    ...
    case 'veggie':
      return (
        <svg {...common}>
          <path
            d="M12 4c4 2 5 5 5 8 0 5-5 8-5 8s-5-3-5-8c0-3 1-6 5-8Z"
            fill="rgba(249,115,22,0.16)"
            stroke="#FB923C"
            strokeWidth="1.8"
          />
          <path
            d="M10 4c-1-2-2-3-3-2M12 4V1M14 4c1-2 2-3 3-2"
            stroke="#34D399"
            strokeWidth="1.7"
            strokeLinecap="round"
          />
    ...
    case 'keto':
      return (
        <svg {...common}>
          <path
            d="M12 3c4.5 0 7 3.5 7 8 0 5.5-3.5 10-7 11-3.5-1-7-5.5-7-11 0-4.5 2.5-8 7-8z"
    ...
    case 'kids':
      return (
        <svg {...common}>
          ...
          />
          <path
            d="M5.5 18c.7-2.5 2.5-4 4.5-4s3.8 1.5 4.5 4"
            stroke="#60A5FA"
            strokeWidth="1.7"
            strokeLinecap="round"
          />
          <path
            d="M13.5 18c.4-1.6 1.5-2.7 3-2.7s2.7 1.1 3 2.7"
            stroke="#A78BFA"
            strokeWidth="1.7"
            strokeLinecap="round"
          />
    ...
    case 'egg':
      return (
        <svg {...common}>
          <path
            d="M12 3C8.8 3 6.5 8 6.5 12.3a5.5 5.5 0 1 0 11 0C17.5 8 15.2 3 12 3Z"
            stroke="#FCD34D"
            strokeWidth="1.7"
    ...
    case 'wheat':
      return (
        <svg {...common}>
          <path d="M12 3v18" stroke={color} strokeWidth="1.7" strokeLinecap="round" />
          <path
            d="M9 8c1 .7 1.8 1 3 .5M15 8c-1 .7-1.8 1-3 .5M9 12c1 .7 1.8 1 3 .5M15 12c-1 .7-1.8 1-3 .5"
            stroke={color}
            strokeWidth="1.6"
    ...
    case 'nuts':
      return (
        <svg {...common}>
          <path
            d="M12 4c4.2 0 6.8 2.7 6.8 6.3 0 4.8-3.4 8.8-6.8 9.7-3.4-.9-6.8-4.9-6.8-9.7C5.2 6.7 7.8 4 12 4Z"
            stroke="#D97706"
            strokeWidth="1.7"
    ...
    case 'peanut':
      return (
        <svg {...common}>
          <path
            d="M10 4.5a3.5 3.5 0 1 0 0 7h4a3.5 3.5 0 1 0 0-7h-4ZM10 12.5a3.5 3.5 0 1 0 0 7h4a3.5 3.5 0 1 0 0-7h-4Z"
            stroke="#F59E0B"
            strokeWidth="1.7"
    ...
    case 'fish':
      return (
        <svg {...common}>
          <path
            d="M20 12c-3-3.4-7-4.8-12-3.4L4 12l4 3.4c5 1.6 9 .2 12-3.4Z"
            stroke="#60A5FA"
            strokeWidth="1.7"
            fill="rgba(96,165,250,0.14)"
          />
          <path
            d="M4 12 2.5 9M4 12l-1.5 3"
            stroke="#60A5FA"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
    ...
    case 'shell':
      return (
        <svg {...common}>
          <path
            d="M15 5c2 1.4 3 3.8 2 6.6l-2 2.8-2.8 1.7-1.7 3.4"
            stroke="#F472B6"
            strokeWidth="1.7"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M15 5c-2 0-3.8 1-5 2.8L8.3 12l1.5 3.2"
            stroke="#F472B6"
            strokeWidth="1.7"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case 'honey':
      return (
        <svg {...common}>
          <path
            d="M9 5h6l2 4v8a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V9l2-4Z"
            stroke="#F59E0B"
            strokeWidth="1.7"
            fill="rgba(245,158,11,0.14)"
          />
          <path d="M7 11h10M7 15h10" stroke="#FBBF24" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
      )
    default:
      return (
        <svg {...common}>
          <circle cx="12" cy="12" r="8" stroke={color} strokeWidth="1.7" fill={fill} />
        </svg>
      )
  }
}
      ...
      {[0, 1, 2].map((index) => (
        <div
          ...
          style={{
            ...
            boxShadow: index === step ? '0 0 18px rgba(124,58,237,0.38)' : 'none',
...
function CircleCard({ children, selected = false, onClick, size = 118, label, delay = 0 }) {
  ...
  return (
    ...
    >
      {children}
      {label && (
        <div style={{ fontSize: 13, fontWeight: 800, lineHeight: 1.14, maxWidth: size - 20 }}>
          {label}
        </div>
      )}
    </Comp>
...
function FeatureByKey(key, labels, rowIndex = 0, itemIndex = 0) {
  ...
  return (
    <FeaturePill
      ...
      name={key}
      label={label}
      wide={label.length > 14}
      delay={(rowIndex * 3 + itemIndex) * 60}
    />
  )
}
    ...
    >
      <div
        style={{
          position: 'absolute',
          inset: 0,
          background: 'radial-gradient(circle at 80% 20%, rgba(124,58,237,0.24), transparent 35%)',
        }}
      />
        ...
        <div style={{ display: 'flex', gap: 14, alignItems: 'stretch' }}>
          <div
            style={{
              ...
              borderRadius: 22,
              border: '1px solid rgba(255,255,255,0.08)',
              background: 'linear-gradient(180deg, rgba(7,7,16,0.9), rgba(19,19,34,0.95))',
              position: 'relative',
              overflow: 'hidden',
            }}
          >
  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        zIndex: 1200,
        background: 'linear-gradient(180deg, #080811 0%, #05050D 100%)',
        overflowY: 'auto',
      }}
    >
      <style>
        {`@keyframes onboardPop { 0% { opacity: 0; transform: scale(.74) translateY(12px); } 60% { opacity: 1; transform: scale(1.05) translateY(-3px); } 100% { opacity: 1; transform: scale(1) translateY(0); } }`}{' '}
      </style>
      <div
        style={{
          position: 'absolute',
          ...
          pointerEvents: 'none',
          background:
            'radial-gradient(circle at 50% -10%, rgba(124,58,237,0.18) 0%, transparent 45%)',
        }}
      />
      <div style={{ position: 'relative', padding: '12px 16px 26px', minHeight: '100%' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <button
                ...
                style={{
                  ...
                  padding: 0,
                  borderRadius: 999,
                  border: `1px solid ${lang === 'ru' ? 'rgba(124,58,237,0.55)' : 'rgba(255,255,255,0.08)'}`,
                  background: lang === 'ru' ? 'rgba(124,58,237,0.14)' : 'rgba(255,255,255,0.03)',
                  color: '#fff',
                  cursor: 'pointer',
                  fontSize: 13,
                  fontWeight: 800,
              ...
              <button
                ...
                style={{
                  ...
                  padding: 0,
                  borderRadius: 999,
                  border: `1px solid ${lang === 'kz' ? 'rgba(124,58,237,0.55)' : 'rgba(255,255,255,0.08)'}`,
                  background: lang === 'kz' ? 'rgba(124,58,237,0.14)' : 'rgba(255,255,255,0.03)',
                  color: '#fff',
                  cursor: 'pointer',
                  fontSize: 13,
                  fontWeight: 800,
        ...
        >
            ...
            <>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 10 }}>
                {FEATURE_ROWS.flat().map((key, idx) =>
                  FeatureByKey(key, featureLabels, Math.floor(idx / 3), idx % 3)
                )}
              </div>
            </>
          )}
          ...
          {step === 1 && (
            <CircleRows
              ...
              gap={4}
              rowGap={8}
              renderItem={(id, rowIndex, itemIndex) => {
                const item = PREFERENCES.find((x) => x.id === id)
                const active = selectedPrefs.has(item.id)
                return (
                  <ChoicePill
                    key={item.id}
                    item={item}
                    label={lang === 'kz' ? item.kz : item.ru}
                    active={active}
                    onClick={() => toggle(setSelectedPrefs, item.id)}
                    size={118}
                    delay={(rowIndex * 3 + itemIndex) * 55}
                  />
                )
              }}
            />
          ...
          {step === 2 && (
            <>
              <CircleRows
                ...
                rowGap={8}
                renderItem={(id, rowIndex, itemIndex) => {
                  const item = ALLERGENS.find((x) => x.id === id)
                  ...
                  return (
                    <ChoicePill
                      ...
                      label={lang === 'kz' ? item.kz : item.ru}
                      active={active}
                      onClick={() => toggle(setSelectedAllergens, item.id)}
                      size={118}
                      delay={(rowIndex * 3 + itemIndex) * 55}
                    />
                  )
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, marginTop: 12 }}>
                    {customItems.map((item) => (
                      ...
                      >
                        {item}
                        <span
                          onClick={() => setCustomItems((prev) => prev.filter((x) => x !== item))}
        ...
        <div
          style={{ display: 'flex', gap: 10, marginTop: step === 2 ? 14 : 24, paddingBottom: 18 }}
        >
          {step > 0 && (
            <button
              onClick={prevStep}
          ...
          <button
            onClick={step === 2 ? finish : nextStep}
            style={{
              flex: 1,
              height: 52,
              borderRadius: 16,
              ...
              fontSize: 16,
              fontWeight: 800,
              boxShadow: '0 10px 30px rgba(124,58,237,0.34)',
              cursor: 'pointer',
            }}
          >

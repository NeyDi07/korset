...
export default function BottomNav() {
  ...
  const getActive = () => {
    ...
    if (pathname.endsWith('/catalog') || pathname === '/catalog' || pathname.includes('/product/')) return 'catalog'
  ...
  const TABS = [
    ...
    {
      id: 'catalog', label: t.nav.catalog, path: buildCatalogPath(storeSlug),
      icon: (on) => on ? (
    ...
    {
      id: 'scan', label: t.nav.scan, path: buildScanPath(storeSlug), isScan: true,
      icon: () => (
    ...
    {
      id: 'ai', label: t.nav.ai, path: buildAIHomePath(storeSlug),
      icon: (on) => on ? (
    ...
    {
      id: 'profile', label: t.nav.profile, path: buildProfilePath(storeSlug),
      icon: (on) => on ? (
